...
class Media(Base):
    ...
    rt_critic_score: Mapped[Optional[float]] = mapped_column(Float)
    rt_audience_score: Mapped[Optional[float]] = mapped_column(Float)
    external_scores_updated_at: Mapped[Optional[datetime]] = mapped_column(DateTime)
